...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Event', fields ['creator']
        db.delete_unique(u'Event_event', ['creator_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Event', fields ['creator']
        db.create_unique(u'Event_event', ['creator_id'])
    ...
    models = {
        ...
        u'Event.event': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event'", 'to': u"orm['CustomUser.User']"}),
