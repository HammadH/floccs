...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'Message_conversation_messages')
        ...
        db.create_unique(m2m_table_name, ['conversation_id', 'personalmessage_id'])


    def backwards(self, orm):
        # Removing M2M table for field messages on 'Conversation'
        db.delete_table(db.shorten_name(u'Message_conversation_messages'))
    ...
    models = {
        ...
        u'Message.conversation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Message.PersonalMessage']", 'symmetrical': 'False'}),
