...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Message_conversation', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conversation', to=orm['CustomUser.User'])),
            ('other_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conv', to=orm['CustomUser.User'])),
        ))
        db.send_create_signal(u'Message', ['Conversation'])

        # Adding M2M table for field conversation on 'PersonalMessage'
        m2m_table_name = db.shorten_name(u'Message_personalmessage_conversation')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personalmessage', models.ForeignKey(orm[u'Message.personalmessage'], null=False)),
            ('conversation', models.ForeignKey(orm[u'Message.conversation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['personalmessage_id', 'conversation_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field conversation on 'PersonalMessage'
        db.delete_table(db.shorten_name(u'Message_personalmessage_conversation'))
    ...
    models = {
        ...
        u'Message.conversation': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'conversation'", 'to': u"orm['CustomUser.User']"})
        },
        u'Message.message': {
        ...
        u'Message.personalmessage': {
            ...
            'conversation': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Message.Conversation']", 'symmetrical': 'False'}),
