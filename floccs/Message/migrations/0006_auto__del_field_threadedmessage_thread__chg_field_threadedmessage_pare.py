...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ThreadedMessage.thread'
        db.delete_column(u'Message_threadedmessage', 'thread_id')


        # Changing field 'ThreadedMessage.parent_object'
        db.alter_column(u'Message_threadedmessage', 'parent_object_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['Message.ThreadedMessage']))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ThreadedMessage.thread'
        raise RuntimeError("Cannot reverse this migration. 'ThreadedMessage.thread' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ThreadedMessage.thread'
        db.add_column(u'Message_threadedmessage', 'thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Message.Thread']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ThreadedMessage.parent_object'
        raise RuntimeError("Cannot reverse this migration. 'ThreadedMessage.parent_object' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ThreadedMessage.parent_object'
        db.alter_column(u'Message_threadedmessage', 'parent_object_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Message.ThreadedMessage']))
    ...
    models = {
        ...
        u'Message.thread': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Message.ThreadedMessage']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        u'Message.threadedmessage': {
            ...
            u'message_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['Message.Message']", 'unique': 'True', 'primary_key': 'True'}),
            'parent_object': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'replies'", 'null': 'True', 'to': u"orm['Message.ThreadedMessage']"})
        },
        u'Projects.project': {
