...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.project_status'
        db.add_column(u'Projects_project', 'project_status',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_status'
        db.delete_column(u'Projects_project', 'project_status')
    ...
    models = {
        ...
        u'Projects.project': {
            ...
            'project_status': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '10'})
        },
        u'auth.group': {
