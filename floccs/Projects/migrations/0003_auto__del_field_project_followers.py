...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.followers'
        db.delete_column(u'Projects_project', 'followers_id')

        # Adding M2M table for field followers on 'Project'
        m2m_table_name = db.shorten_name(u'Projects_project_followers')
    ...
    def backwards(self, orm):
        # Adding field 'Project.followers'
        db.add_column(u'Projects_project', 'followers',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='following_ideas', null=True, to=orm['CustomUser.User'], blank=True),
                      keep_default=False)

        # Removing M2M table for field followers on 'Project'
        db.delete_table(db.shorten_name(u'Projects_project_followers'))
