...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Marker.event'
        db.alter_column(u'Markers_marker', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['Event.Event']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Marker.event'
        raise RuntimeError("Cannot reverse this migration. 'Marker.event' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Marker.event'
        db.alter_column(u'Markers_marker', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['Event.Event']))
    ...
    models = {
        ...
        u'Markers.marker': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'marker'", 'unique': 'True', 'null': 'True', 'to': u"orm['Event.Event']"}),
