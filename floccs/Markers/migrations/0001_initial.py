...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Marker'
        db.create_table(u'Markers_marker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='marker', unique=True, to=orm['Event.Event'])),
        ))
        db.send_create_signal(u'Markers', ['Marker'])


    def backwards(self, orm):
        # Deleting model 'Marker'
        db.delete_table(u'Markers_marker')
    ...
    models = {
        ...
        u'Markers.marker': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'marker'", 'unique': 'True', 'to': u"orm['Event.Event']"}),
